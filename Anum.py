...
█▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄█
\033[1;97m⊱• ────────────  ──────────── •⊰
\033[1;96m≫ \033[1;96m CODDED BY :\033[1;95m آنم اقبال
\033[1;96m≫ \033[1;96m FACEBOOK:\033[1;95m انم اقبال
\033[1;96m≫ \033[1;96m WHATSAPP :\033[1;95m +not available
...
while (loop == 'true'):
    ...
    if (username == CorrectUsername):
        ...
        if (password == CorrectPassword):
            print "\033[1;32mACCESS GRANTED AS " + username #Dev:MR_TRICKER
	    time.sleep(2)
            loop = 'false'
        else:
            print "\033[1;31mACCESS DENIED"
            os.system('xdg-open https://wa.me/+92342-9655210')
    else:
        print "\033[1;31mACCESS DENIED"
        os.system('xdg-open https://wa.me/+92342-9655210')
	...
	try:
		...
		if 'save-device' in url:
			try:
				...
				os.system('xdg-open https://wa.me/+03427777272')
...
def menu():
	...
	print "\033[1;93mANUM THE OFFICIAL PROGRAMMER[ A•O•P ]"
...
def pilih_super():
	...
	if peak =="":
		...
		print """\033[1;32m
⊱• ─────────ANUM THE OFFICIAL PROGRAMMER[ A.O.P ] ───────── •⊰
"""
...
──▄████▄──▐▌──▄████▄─"""
	...
	p.map(main, id)
	print "\033[1;32m⊱• ──────────── ──────────── ──────────── •⊰"
	print "  \033[1;93m⊱•─── Developed By MR TRICKER ─── •⊰" #Dev:trickr
...
Checkpoint ID Open After 7 Days
 Having Problem Whatsapp Me :+not available"""
